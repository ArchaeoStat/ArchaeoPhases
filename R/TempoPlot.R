...
#' @param plot.result a list containing the data to plot,
#' typically the result of a previous run of \code{TempoPlot()}
#' @param print.data.result If \code{TRUE}, a list containing the data to plot will be given
#' @param level probability corresponding to the level of confidence
#' @param count, if \code{TRUE} the counting process is a number, otherwise it is a probability
#' @param Gauss if \code{TRUE}, the Gaussian approximation of the credible interval is used
...
#' @param line.types type of the lines drawn on the graph in the order of \code{legend.labels}
...
#' @param colors if \code{TRUE}, the graph is drawn with colors,
#' otherwise it is drawn in black and white
#' @param file the name of the file that will be saved if chosen, if \code{NULL} no file is saved.
...
#' @param print.data.result If \code{TRUE}, the list containing the data to plot will be returned
#'
