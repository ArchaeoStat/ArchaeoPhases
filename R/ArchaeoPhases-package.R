...
#' @importFrom ggplot2 aes facet_grid ggplot geom_area geom_path geom_rect
#' geom_segment scale_x_continuous scale_x_reverse scale_y_continuous
#' scale_y_discrete vars
