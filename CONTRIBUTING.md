...
guide**](https://github.com/ArchaeoStat/ArchaeoPhases/blob/master/.github/CONTRIBUTING.md).
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("tesselle/PACKAGE", fork = TRUE)`.
...
Conduct](https://github.com/ArchaeoStat/ArchaeoPhases/blob/master/.github/CODE_OF_CONDUCT.md).
