...
Creates a matrix of observed frequencies of a given Allen set among two
or more groups of chains from the MCMC output of a Bayesian calibration.
...
- set:
  ...
  representation of an Allen set.

## Value

A square [`matrix`](https://rdrr.io/r/base/matrix.html) of observed
frequencies.
