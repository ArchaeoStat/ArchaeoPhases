...
![plot of chunk
read-chronomodel-events](figures/read-chronomodel-events-1.png)
...
![plot of chunk
read-chronomodel-phases](figures/read-chronomodel-phases-1.png)

plot of chunk read-chronomodel-phases

## Oxcal

Oxcal generates a CSV file containing the MCMC samples of all parameters
(dates, start and end of phases).
...
![plot of chunk read-oxcal](figures/read-oxcal-1.png)

plot of chunk read-oxcal

The phase boundaries cannot be extracted automatically from Oxcal
output. Use
[`as_phases()`](https://ArchaeoStat.github.io/ArchaeoPhases/reference/as_phases.md)
to get the phase boundaries:
...
![plot of chunk oxcal-phases](figures/oxcal-phases-1.png)

plot of chunk oxcal-phases

## BCal

BCal generates a CSV file containing the MCMC samples of all parameters
(dates, start and end of groups).
...
The group boundaries cannot be extracted automatically from BCal output.
Use
[`as_phases()`](https://ArchaeoStat.github.io/ArchaeoPhases/reference/as_phases.md)
to get the group boundaries:
...
![plot of chunk bcal-phases](figures/bcal-phases-1.png)
