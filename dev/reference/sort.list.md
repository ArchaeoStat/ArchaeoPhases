...
Returns a permutation which rearranges an object into ascending or
...
An [`integer`](https://rdrr.io/r/base/integer.html) vector.

## See also

Other mutators:
[`names`](https://ArchaeoStat.github.io/ArchaeoPhases/dev/reference/names.md),
