...
- x:
  ...
  A [`character`](https://rdrr.io/r/base/character.html) vector or
  matrix of Allen relations (typically returned by
...
A [`character`](https://rdrr.io/r/base/character.html) vector or matrix
(same as `x`).
