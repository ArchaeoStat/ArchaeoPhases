...
- x, y:
  ...
  lower and upper boundaries of the time intervals, respectively. If `y`
  is missing, an attempt is made to interpret `x` in a suitable way (see
...
A [`character`](https://rdrr.io/r/base/character.html) matrix specifying
the Allen relations.
