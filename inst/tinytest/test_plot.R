if (at_home()) {
  ...
  plot_event_decr <- function() plot(eve, interval = "credible", decreasing = TRUE)
  expect_snapshot_plot(plot_event_decr, "plot_event_decr")

  plot_event_incr <- function() plot(eve, interval = "credible", decreasing = FALSE)
  ...
  plot_phase_decr <- function() plot(pha, range = NULL, decreasing = TRUE)
  expect_snapshot_plot(plot_phase_decr, "plot_phase_decr")

  plot_phase_inc <- function() plot(pha, range = NULL, decreasing = FALSE)
